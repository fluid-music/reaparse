...
describe('rppProjectToCsv', async function () {
  ...
  describe('csv parsing', function () {
    ...
    const kick = { name: 'kick', startInSourceSeconds: 0, path: 'media/kick.wav', trackName: '1-kick', trackNumber: 0 }
    const snare = { name: 'snare', startInSourceSeconds: 0, path: 'media/snare.wav', trackName: '2-snare', trackNumber: 1 }
